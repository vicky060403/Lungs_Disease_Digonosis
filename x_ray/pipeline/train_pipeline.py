...
from x_ray.components.data_ingestion import DataIngestion
from x_ray.components.data_transformation import DataTransformation
from x_ray.components.model_evaluation import ModelEvaluation

from x_ray.components.model_training import ModelTrainer
from x_ray.components.model_pusher import ModelPusher
...
from x_ray.entity.config_entity import (
    DataIngestionConfig,
    ...
    def run_pipeline(self) -> None:
        ...
        try:
            ...
            logging.info(
                ...
                f"Accuracy: {model_evaluation_artifact.model_accuracy:.2f}%"
            )
